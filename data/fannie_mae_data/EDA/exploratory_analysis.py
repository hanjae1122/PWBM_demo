...
NONZERO_netloss = pd.DataFrame(NET_loss, index=ind) 
x = NONZERO_netloss.loc[NONZERO_netloss['ORIG_YR'] == 2000]['NET_LOSS_AMT']
y = NONZERO_netloss.loc[NONZERO_netloss['ORIG_YR'] == 2007]['NET_LOSS_AMT']

fig, axs = plt.subplots(1, 2, sharey=True, tight_layout=True)
axs[0].hist(x)
axs[1].hist(y)

n_2012 = NET_loss.loc[NET_loss['ORIG_YR'] == 2012].shape[0]
n_2016 = NET_loss.loc[NET_loss['ORIG_YR'] == 2016].shape[0]

nzn_2012 = NET_loss.loc[NET_loss['ORIG_YR'] == 2012]['NET_LOSS_AMT'].nonzero()[0].shape[0]
nzn_2016 = NET_loss.loc[NET_loss['ORIG_YR'] == 2016]['NET_LOSS_AMT'].nonzero()[0].shape[0]

p_2012 = nzn_2012/n_2012
p_2016 = nzn_2016/n_2016
